...
\textbf{Baselines.}
BRITS~\citep{cao2018brits} and SAITS~\citep{du2023saits} via PyPOTS~\citep{du2023saits}, plus standard coarse methods (zero fill, mean fill, linear interpolation).
